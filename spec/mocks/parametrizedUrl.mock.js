...
(function () {
	module.exports = jasmine.createSpy('parametrizedUrl').andCallFake(function () {
		var parametrizedUrl = jasmine.createSpyObj('parametrizedUrl', ['getUrl']);
		parametrizedUrl.getUrl.andReturn('fooUrl');
